...
- Added a bounded #70 benchmark comparison report and Terminal-Bench repo contract, keeping local HEB pilot results separate from public external benchmark adapter evidence.
