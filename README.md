...
- [Dogfooding guide](docs/dogfooding.md), [benchmark protocol](docs/benchmark-protocol.md), and [benchmark runner/schema](docs/benchmark-runner.md) - how this repo keeps the template trim and evaluates adoption outcomes.
