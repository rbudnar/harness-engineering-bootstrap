...
- [Dogfooding guide](docs/dogfooding.md), [benchmark protocol](docs/benchmark-protocol.md), [benchmark runner/schema](docs/benchmark-runner.md), and [first pilot report](docs/benchmark-pilot-2026-07.md) - how this repo keeps the template trim and evaluates adoption outcomes.
