...
- [Dogfooding guide](docs/dogfooding.md), [benchmark protocol](docs/benchmark-protocol.md), [benchmark runner/schema](docs/benchmark-runner.md), [Terminal-Bench comparison runner](scripts/terminal-bench-comparison.mjs), [first pilot report](docs/benchmark-pilot-2026-07.md), and [benchmark governance](docs/benchmark-governance.md) - how this repo keeps the template trim and evaluates adoption outcomes without overstating evidence.
...
- Minimal local metrics first; PR metrics, scheduled reports, and benchmark runner/result schemas only when triggered.
