...
- Repo-local skills are pulled context under the Agent Skills `SKILL.md` format, not always-on guidance; current skill: `.agents/skills/contract-memory/SKILL.md` for contract-memory work.
